...
#folium.CircleMarker(location=[47.391153, -0.626613],radius=10,color='black',fill=True,fill_color='black').add_to(m)
folium.Marker([47.3855089,-0.6449059], tooltip=tooltips,icon = folium.Circle(color = 'black')).add_to(m)
